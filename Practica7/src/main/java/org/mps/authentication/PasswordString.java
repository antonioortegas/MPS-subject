...
/**
 * Class used to store and validate a string that will be used as a
 * password.
 * <p>
 * A string is a valid password if their length is in the range [8, 20] and it
 * contains at least a number and at least a special character from the set
 * {'.', ',',':','?','¿'}
 */
